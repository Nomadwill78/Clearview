...
type FinancingType = "cash" | "hardmoney";
...
export default function DealAnalyzer() {
  ...
  function setFinancing(type: FinancingType) {
    setForm((prev) => ({ ...prev, financingType: type }));
  }
  ...
  const results = useMemo<Results | null>(() => {
    ...
    const rehab = parseFloat(form.rehabBudget);
      ...
      <header className="sticky top-0 z-10 border-b border-slate-800 bg-slate-950/90 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="hidden sm:block text-slate-400 text-sm">Deal Analyzer</span>
          </div>
          {results && (
            <div
          ...
          <section className="space-y-4">
            <div className="bg-slate-900 rounded-xl border border-slate-800 p-5">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div>
                  <LabelText>Rehab Budget</LabelText>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 text-sm pointer-events-none">
                      $
                    </span>
              ...
              <>
                ...
                <div className="bg-slate-900 rounded-xl border border-slate-800 p-5">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <CostRow label="Rehab Budget" value={results.costStack.rehabBudget} />
